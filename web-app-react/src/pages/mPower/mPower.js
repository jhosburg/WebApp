...
const mPower = () => {
  return (
    <div className="centered-image-container">
      ...
      <p className="centered-text">Storing energy remains costly, making the ability to squeeze value out
         ...
         essential circuits, mPower enables a home or business owner to easily employ 
         ...
         allows it to be tailored to any specific number of breakers. Allows users to 
        energy storage consumption efficiently and cost-effectively, delivers discretion over
